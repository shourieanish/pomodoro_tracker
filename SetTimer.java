...
public class SetTimer implements ActionListener, ItemListener {
    ...
    public SetTimer(boolean isWork) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == start) {
            if (hr+min+sec == 0) {
                ...
                frame.dispose();
                new RunTimer(hr, min, sec, isWork);
            }
